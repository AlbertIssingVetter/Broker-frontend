    ...
    render() {
        return (
            <div className="market">
                <ToggleButtonGroup onChange={this.handleChangeReference} exclusive
                ...
                <Typography variant="h5" gutterBottom>{coins[this.props.match.params.marketId].name}</Typography>
